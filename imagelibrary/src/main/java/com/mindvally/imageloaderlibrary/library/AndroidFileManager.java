package com.mindvally.imageloaderlibrary.library;
...
public class AndroidFileManager {
    ...
    public static void deleteFile(Context context, String fileUri, String fileNamePrefix, String dirName, @MVLoader.DirectoryType int dirType) throws Exception {
        File fileToDelete = getFileForRequest(context, fileUri, fileNamePrefix, dirName, dirType);
        if (fileToDelete.exists())
            fileToDelete.delete();
    }

    public static File searchAndGetLocalFile(Context context, String uri, String fileNamePrefix, String dirName, @MVLoader.DirectoryType int dirType) throws Exception {
        File foundFile = null;
